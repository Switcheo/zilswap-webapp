  ...
  return (
    <ContrastBox className={classes.showAdvanced}>
      <Box alignItems="center" display="flex" mb={2} width="100%">
        <Typography variant="h3">Advance Setting</Typography>
        <Box flexGrow={1} />
        <IconButton className={classes.iconButton} onClick={() => { setNewSlippage(slippage); dispatch(actions.Layout.showAdvanceSetting(false)) }}>
          <CloseIcon />
        </IconButton>
      </Box>
