...
//   imageURL: 'https://switcheo-assets.s3.ap-southeast-1.amazonaws.com/zilswap/banner-zilstream.png',
//   tokenSymbol: 'BLOX',
//   tokenName: 'Zilliqa Royale',
//   tokenDecimals: 2,
//   description: 'ZilliqaRoyale is a first of its kind blockchain-powered battle royale game running on Minecraft, bringing innovation to the Zilliqa network by being a proof-of-concept that demonstrates how games can be integrated with blockchain technology seamlessly.',
//   contractAddress: 'zil1gf5vxndx44q6fn025fwdaajnrmgvngdzel0jzp',
//   showUntil: dayjs('2021-08-16T10:00:00.000+0800'),
//   usdRatio: '0.86',
//   usdTarget: '$550,000',
  }],
